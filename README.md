...
<img src="./GreatPumpkin.jpg" alt="Alt text" width="100%">
...
- Start
  - :warning: **This is important, the first point needs to be included in the route, since we will have to tell Sally where to start the maze!**
- Down 5
- Right 2
- Up 2
- Right 3
